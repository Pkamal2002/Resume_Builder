...
const TemplateSelector = ({selectedTemplate, onchange}) => {
  ...
  const templates = [
    ...
    { id: "modern", name: "Modern", preview: "A sleek, contemporary design with bold elements and modern layout" },
    { id: "minimal", name: "Minimal", preview: "A clean, minimalist approach with ample white space and simple formatting" },
    { id: "minimal-image", name: "Minimal with Image", preview: "A clean, minimalist design with a profile image section" }
  ];
